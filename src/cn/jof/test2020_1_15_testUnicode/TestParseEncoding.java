 ...
 * 
 */
public class TestParseEncoding {
	 ...
	 * IBM01148 IBM01149 IBM037 IBM1026 IBM1047 IBM273 IBM277 IBM278 IBM280
	 ...
	 * IBM869 IBM870 IBM871 IBM918 ISO-2022-CN ISO-2022-JP ISO-2022-JP-2
	 ...
	 * x-IBM1364 x-IBM1381 x-IBM1383 x-IBM33722 x-IBM737 x-IBM833 x-IBM834
	...
	public static void main(String[] args) throws IOException {
		...
		String s1 = new String(bytes, "IBM855");
		String s2 = new String(s1.getBytes("IBM855"), GBK);
		System.out.println(s2);
		System.out.println("-----转化为ISO-8859-1和转回GBK");
		s1 = new String(bytes, "ISO-8859-1");
		s2 = new String(s1.getBytes("ISO-8859-1"), GBK);
		System.out.println(s2);
		System.out.println("-----转化为UTF-8和转回GBK");
		s1 = new String(bytes, "UTF-8");
		s2 = new String(s1.getBytes("UTF-8"), GBK);
		System.out.println(s2);
		s1.getBytes();
	}
